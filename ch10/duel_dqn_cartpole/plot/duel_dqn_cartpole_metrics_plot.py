...
y_ae = []
y_mae = []
with open('../output/train_1000steps_Sat_Sep_15_01:32:09_2018.log','r') as csvfile:
...
axarr[1].set_title('Duel DQN CartPole Episode vs Absolute Error')

axarr[2].plot(x, y_mae,color='r')
axarr[2].set_title('Duel DQN CartPole Episode vs Mean Absolute Error')
